(function($) {
	...
	$.fn.irclock.update = function() {
		...
		/* Check the alarm */
		var alarmstampCurrent = date.getUTCHours() * 3600 + date.getUTCMinutes() * 60 + date.getUTCSeconds();
		...
		alarmText += " " + alarmdate.getUTCHours() + ":" + ((alarmdate.getUTCMinutes() < 10) ? "0" : "") + alarmdate.getUTCMinutes();
		/* Update the date */
